...
* [**Fonti Kar**](https://fontikar.github.io/). Email: [fonti.kar@monash.edu](mailto:fonti.kar@monash.edu)
...
* 2 hour seminar, Friday 2pm-4pm each week
* 1 hour workshop, Friday 4pm-5pm each week
...
* Michael Lydeamore: Tuesdays 1.30pm-2.30pm (Rm 354, Building 6 [Clayton campus])
* Fonti Kar: Thursdays 2pm-4pm (Hybrid, H6.48 [Caulfield campus])
...
schedule |>
    transmute(
        ...
        Show_Workshop = !is.na(Week) & Week <= 12,
        Topic = if_else(!Show, Topic, glue::glue('[{{Topic}}](./week{{Week}}/index.html){target="_blank"}', .open = "{{", .close = "}}")),
        Workshop = if_else(!Show_Workshop, "", glue::glue('[{{< fa pen >}}](./week{{{Week}}}/workshop/index.html){target="_blank"}', .open = "{{{", .close = "}}}")),
    ...
    select(-Show, -Show_Tutorial, -Show_Workshop) |>
    knitr::kable(
        format = "markdown",
        align = c("r", "l", "l", "c", "c", "l", "l")
    )
```
