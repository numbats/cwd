...
* Enable audience to some degree **co-author narrative**, i.e. narratives move away from being author-guided to audience-driven.
...
The balance of benefits and costs for using an interactive visualisation approach. E.g. does the human effort of building the interactive visualisation outweigh its benefits? Are the efforts of users to interact with it offset by the information gained for users?
...
* **Confirmation** finds concrete evidence for or against a hypothesis 
...
<i class="fa-solid fa-gear fa-spin"></i> [Demo App](https://shiny.posit.co/r/gallery/government-public-sector/nz-trade-dash/)
...
* You learnt how to make web apps using `shiny`
