...
- Communicate your data story clearly in a short verbal presentation
...
* Add a photo (or some representation) of you
...
* Findings of the analysis clearly described (2 marks)
...
### Part D: Recorded data-story briefing (5 marks)

Record an individual **3--5 minute** verbal presentation that communicates the data story from your blog post to its intended audience. You may use the figures and tables from your blog post as visual support, but the recording should be led by your spoken explanation rather than by text on screen.
...
* explain the most important finding(s), referring to relevant visual evidence; and
...
* Logical structure suited to the intended audience (1 mark)
* Clear, concise verbal delivery within the time limit (2 marks)
...
**Maximum grade**: 4 + 3 + 17 + 5 + 3 = 32 marks
