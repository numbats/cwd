...
- You may want to build a vignette (article) for these cases.
...
- You can easily add this via `usethis::use_package()`
...
* Make sure you have a `BugReports` and `URL` with `devtools::use_github_links()`
:::
...
- Sharing your package by making it easy to install, committing to good documentation, and making the documentation accessible helps to build trust to use your package.
