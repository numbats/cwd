...
* Testing can increase the trustworthiness of the package
...
- Sharing your package by making it easy to install, implementing unit tests, committing to good documentation, and making the documentation accessible helps to build trust to use your package.
