...
[Check out the REPL](https://webr.r-wasm.org/latest/)
...
::: {.fragment}
* Is how the [startr.numbat.space](https://startr.numbat.space/) website works
:::
...
At some poinmt you'll almost certainly need to draw a flow diagram. Quarto can do this using [Mermaid](https://mermaid.js.org/).
...
locations <- tibble::tribble(
  ~name,                           ~lat,       ~lng,
  "Melbourne CBD",                 -37.8136,  144.9631,
  "Monash University (Caulfield)", -37.8768,  145.0450,
  "University of Melbourne",       -37.7964,  144.9633
)
